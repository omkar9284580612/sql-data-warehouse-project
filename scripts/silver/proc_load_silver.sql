...
===============================================================================
Script purpose:
         This store procedure performs the E-T-L ELT(Extract, Transfer, Load)
          process to populate the  silver schema Table from the Bronze schema.
=================================================================================
*/
...
SELECT 
  prd_id,
  SUBSTRING(prd_key, 7, LEN(prd_key)) AS prd_key, -- derived prd_key
